...
case class RDSPaymentPlan(scheduledPaymentAmount: Option[BigDecimal],
...
object RDSDDPaymentPlansResponse {
  ...
  import RDSPaymentPlan.format

  implicit val format: OFormat[RDSDDPaymentPlansResponse] = Json.format[RDSDDPaymentPlansResponse]
}
